...
class GeneradorXML
{
    //CREAR LOS XML DE BOLETA Y FACTURA, USANDO EL METODO SENDBILL
    public function CrearXMLFactura($nombreXML, $emisor, $cliente, $comprobante, $detalle, $cuotas = null)
    {
        $doc = new DOMDocument();
        ...
        //crear una variable que es el texto del UBL O XML DE INVOICE
    ...
    //Resumen diario - UBL SummaryDocuments
